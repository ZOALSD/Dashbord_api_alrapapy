...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 video">
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="custom-file">
                        {!! Form::file('video',['class'=>'custom-file-input','placeholder'=>trans('admin.video'),"accept"=>it()->acceptedMimeTypes("video"),"id"=>"video"]) !!}
        ...
        <div class="col-md-4" style="padding-top: 30px;">
            <div class="row">
                <div class="col-md-6">
                    @include("admin.show_video",["video"=>$videos->video])
                </div>
                <div class="col-md-6">
                    <a href="{{ it()->url($videos->video) }}" target="_blank"><i class="fa fa-download fa-2x"></i></a>
                </div>
            </div>
        </div>
    </div>
