...
class VideosApi extends Controller{
	protected $selectColumns = [
		...
		"video",
            ...
            {
            	$video = video::select($this->selectColumns)->get();
    ...
    public function store(VideosRequest $request)
    {
        ...
        $video = video::create($data); 
              ...
              $video->video = it()->upload("video","videos/".$video->id);
              $video->save();
              }
        ...
        return successResponseJson([
            ...
            public function update(VideosRequest $request,$id)
            {
              ...
              $data["user_id"] = auth()->id(); 
               if(request()->hasFile("video")){
              it()->delete($video->video);
              $data["video"] = it()->upload("video","videos/".$video->id);
               }
