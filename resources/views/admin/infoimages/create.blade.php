	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('infoimages') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/infoimages'),'id'=>'infoimages','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
