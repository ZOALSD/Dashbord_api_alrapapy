 ...
 <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="{{ aurl('/infoimages/'.$id.'/edit')}}" class="dropdown-item" ><i class="fas fa-edit"></i> {{trans('admin.edit')}}</a>
		<a href="{{ aurl('/infoimages/'.$id)}}" class="dropdown-item" ><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
