...
class infoimagesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.infoimages.buttons.actions')
    ...
    {
        return infoimage::query()->select("infoimages.*");
