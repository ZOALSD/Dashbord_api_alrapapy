...
use Validator;
use App\Http\Controllers\ValidationsApi\V1\categoriesControllerRequest;
...
class categoriesControllerApi extends Controller{
	protected $selectColumns = [
		...
		"parent_id",
             ...
             * @return \Illuminate\Http\Response
             */
    public function store(categoriesControllerRequest $request)
    {
        ...
        return successResponseJson([
            ...
            public function updateFillableColumns() {
				       $fillableCols = [];
				       foreach (array_keys((new categoriesControllerRequest)->attributes()) as $fillableUpdate) {
            ...
            public function update(categoriesControllerRequest $request,$id)
            {
